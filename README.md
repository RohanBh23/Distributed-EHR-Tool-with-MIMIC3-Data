...
Here also we have used specific SQL queries to retrieve the required data from the databases. And then we have performed statistical tests on that on the retrieved data. 
